# Generated by Django 4.2.30 on 2026-07-15 09:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gab', '0002_alter_filiale_options_alter_fournisseur_options_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='ActivationGabs',
            fields=[
                ('id_activation', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='NewActionIntervention',
            fields=[
                ('id_intevention', models.AutoField(primary_key=True, serialize=False)),
                ('event', models.CharField(db_collation='utf8_bin', max_length=25)),
                ('msg', models.CharField(db_collation='utf8_bin', max_length=200)),
                ('libelle_intevention', models.CharField(db_collation='utf8_bin', max_length=80, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_trans', models.DateTimeField(db_column='last_Trans')),
                ...
                ('up_last_trans', models.DateTimeField(db_column='up_last_Trans')),
                ...
                ('last_inservice_cloture', models.DateTimeField(db_column='last_InService_cloture')),
                ('trans_caused_cloture', models.DateTimeField(db_column='Trans_caused_cloture')),
        ...
        migrations.CreateModel(
            name='NewInteventionIncident',
            fields=[
                ('id_action_interv', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gsm_contact', models.CharField(blank=True, max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('importance', models.CharField(db_column='Importance', max_length=2)),
                ('id_fournisseur', models.IntegerField()),
